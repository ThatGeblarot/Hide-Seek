...
/**
 * Esta clase contiene todos los métodos relacionados con el manejo de clientes
 * inscritos.
 * 
...
public class ClienteDAO {
	...
	/**
	 * Este es el constructor de la clase ClienteDAO el objeto de clase
	 * ArchivoTiendas ha sido creado previamente <br>
	 ...
	 * userid y correo. <b>pre</b> el ArrayList de clientes esta inicializado (no es
	 * null). <br>
	 ...
	 */
	public boolean actualizarCliente(ArrayList<Cliente> clientes, String userid, String nuevouser, String correo,
			String nombre) {
	...
	/**
	 * Este metodo sirve para cambiar el cupo del cliente <b>pre</b> el ArrayList de
	 * clientes esta inicializado (no es null). <br>
	...
	/**
	 * Este metodo agrega un cliente <b>pre</b> el ArrayList de clientes esta
	 * inicializado (no es null). <br>
	...
	public boolean agregarCliente(ArrayList<Cliente> clientes, String nombre, double cupo, String userid, String correo,
	...
	/**
	 * Este metodo elimina un cliente <b>pre</b> el ArrayList de clientes esta
	 * inicializado (no es null). <br>
	...
	/**
	 * Esta clase compara la contraseña ingresada con la del cliente <b>pre</b> el
	 * ArrayList de clientes esta inicializado (no es null). <br>
	...
	/**
	 * Este metodo agrega una pareja <b>pre</b> los ArrayList de clientes y parejas
	 * estan inicializados (no son null) <br>
	...
	public boolean agregarPareja(ArrayList<Cliente> clientes, String userid, String nombre, double cupo, String userpareja, String correo, String contraseña, String genero) {
		Pareja nuevo = new Pareja(nombre, cupo, userpareja, correo, contraseña, genero);
		Cliente c = buscarCliente(clientes, userid);
	...
	/**
	 * Este método compara la clave real de la pareja con una enviada desde el
	 * login. <b>pre</b> la pareja se encuentra en el arraylist de parejas <br>
	 ...
	 * @param clavepareja es la clave de la pareja a comparar con la que está
	 *                    guardada.
	 ...
	 * <b>pre</b> los ArrayList de clientes y parejas estan inicializados (no son
	 * null) <br>
	 * <b>post</b> Se ha agregado la restriccion a la pareja de el usuario
	 * especifico <br>
	 * 
	 * @param clientes   es el ArrayList de los clientes inscritos.
	...
	public boolean agregarHorario(ArrayList<Cliente> clientes, String userid, String userpareja, String dia,
	 ...
	 * userid y correo. <b>pre</b> el ArrayList de clientes esta inicializado (no es
	 * null). <br>
	 * <b>post</b> Se han cambiado los atributos de la pareja con usuario especifico
	 * <br>
	 * 
	 * @param clientes   clientes es el ArrayList de los clientes inscritos.
	 * @param userid     es la identificación de usuario del cliente inscrito.
	...
	public boolean actualizarPareja(ArrayList<Cliente> clientes, String userid, String userpareja, String nuevouser,
	...
	/**
	 * Este metodo elimina una pareja de un cliente <b>pre</b> el ArrayList de
	 * clientes esta inicializado (no es null). <br>
